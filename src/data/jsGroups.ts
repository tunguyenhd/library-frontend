    ...
    cards: [
      {
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "statement;" },
          { title: "Ví dụ", code: "const button = document.querySelector(\"button\");\n\nbutton?.addEventListener(\"click\", () => {\n  alert(\"Xin chào JavaScript!\");\n});" },
        ],
      },
      {
        id: "js-embedding",
        ...
        codeBlocks: [
          { title: "Viết trong HTML", code: "<script>\n  console.log(\"JavaScript trong HTML\");\n</script>" },
          { title: "Liên kết file riêng", code: "<script src=\"./main.js\"></script>" },
        ],
      },
      {
        id: "js-console-log",
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "console.log(value);" },
          { title: "Ví dụ", code: "const courseName = \"JavaScript cơ bản\";\nconsole.log(courseName);" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "document.write(content);" },
          { title: "Ví dụ", code: "document.write(\"<h1>Xin chào JavaScript</h1>\");" },
        ],
      },
      {
        id: "js-variables",
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "let variableName = value;\nconst constantName = value;" },
          { title: "Ví dụ", code: "const courseName = \"JavaScript\";\nlet coursePrice = 500000;\nlet isLoggedIn = false;" },
        ],
      },
      {
        id: "js-var",
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "var variableName = value;" },
          { title: "Ví dụ", code: "var userName = \"Tú\";\nvar courseName = \"JavaScript cơ bản\";" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Tên hợp lệ", code: "const courseName = \"JavaScript\";\nconst userEmail = \"user@example.com\";\nconst totalPrice = 500000;" },
          { title: "Tên không hợp lệ", code: "// const 1user = \"Tú\";\n// const user-name = \"Tú\";\n// const class = \"JavaScript\";" },
        ],
      },
      {
        id: "js-assign-value",
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "let variableName;\nvariableName = value;" },
          { title: "Ví dụ", code: "let courseName;\ncourseName = \"JavaScript cơ bản\";\n\nlet coursePrice = 500000;" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "let firstVariable = value,\n    secondVariable = value;" },
          { title: "Ví dụ", code: "const userName = \"Tú\",\n  userEmail = \"tu@example.com\",\n  phoneNumber = \"0123456789\";" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "stringA + stringB;" },
      ...
      },
      {
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "`Text ${expression}`" },
      ...
      },
      {
        ...
        codeBlocks: [
          { title: "Comment một dòng", code: "// Khai báo tên khóa học\nconst courseName = \"JavaScript\";" },
          { title: "Comment nhiều dòng", code: "/*\n  Kiểm tra dữ liệu người dùng\n  trước khi gửi form\n*/" },
        ],
      },
    ],
  },
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"if (condition) {\n  // Chạy khi điều kiện đúng\n} else {\n  // Chạy khi điều kiện sai\n}"},{"title":"Ví dụ","code":"if (isLoggedIn) {\n  showProfile();\n} else {\n  redirectToLogin();\n}"}]
      },
      {
        "id": "js-if",
        "title": "If",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"if (condition) {\n  statement;\n}"},{"title":"Ví dụ","code":"const quantity = 2;\n\nif (quantity > 0) {\n  addToCart();\n}"}]
      },
      {
        "id": "js-if-else",
        "title": "If else",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"if (condition) {\n  statementIfTrue;\n} else {\n  statementIfFalse;\n}"},{"title":"Ví dụ","code":"if (inputPassword === savedPassword) {\n  login();\n} else {\n  showError(\"Mật khẩu không đúng\");\n}"}]
      },
      {
        "id": "js-else-if",
        "title": "Else if",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"if (conditionA) {\n  ...\n} else if (conditionB) {\n  ...\n} else {\n  ...\n}"},{"title":"Ví dụ","code":"if (score >= 8) {\n  rank = \"Giỏi\";\n} else if (score >= 6.5) {\n  rank = \"Khá\";\n} else if (score >= 5) {\n  rank = \"Trung bình\";\n} else {\n  rank = \"Yếu\";\n}"}]
      },
      {
        "id": "js-nested-if",
        "title": "If lồng nhau",
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"if (leftValue comparisonOperator rightValue) {\n  statement;\n}"},{"title":"Ví dụ","code":"const age = 20;\n\nif (age >= 18) {\n  allowAccess();\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"if (conditionA && conditionB) { ... }\nif (conditionA || conditionB) { ... }\nif (!condition) { ... }"},{"title":"Ví dụ","code":"const canSubmit = email !== \"\" && password.length >= 8;\n\nif (canSubmit) {\n  submitForm();\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Công thức","code":"Lương thực nhận = Lương tổng - (Lương tổng × Thuế suất)"},{"title":"Ví dụ","code":"const grossSalary = 18000000;\nlet taxRate;\n\nif (grossSalary < 5000000) {\n  taxRate = 0.05;\n} else if (grossSalary <= 15000000) {\n  taxRate = 0.1;\n} else {\n  taxRate = 0.15;\n}\n\nconst netSalary = grossSalary - grossSalary * taxRate;\nconsole.log(netSalary);"}]
      },
      {
        "id": "js-switch-case",
        "title": "Switch case",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"switch (value) {\n  case expectedValue:\n    statement;\n    break;\n  default:\n    statement;\n}"},{"title":"Ví dụ","code":"switch (action) {\n  case \"create\":\n    console.log(\"Thêm\");\n    break;\n  case \"edit\":\n    console.log(\"Sửa\");\n    break;\n  case \"delete\":\n    console.log(\"Xóa\");\n    break;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"case expectedValue:\n  statement;\n  break;"},{"title":"Ví dụ","code":"switch (action) {\n  case \"create\":\n    createItem();\n    break;\n}"}]
      },
      {
        "id": "js-switch-break",
        "title": "Break",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"break;"},{"title":"Ví dụ","code":"case \"create\":\n  createItem();\n  break;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"default:\n  statement;"},{"title":"Ví dụ","code":"switch (action) {\n  case \"create\":\n    createItem();\n    break;\n  default:\n    showList();\n}"}]
      },
      {
        "id": "js-grouped-cases",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"case valueA:\ncase valueB:\ncase valueC:\n  sharedStatement;\n  break;"},{"title":"Ví dụ","code":"switch (action) {\n  case \"create\":\n  case \"insert\":\n  case \"add\":\n    console.log(\"Thêm\");\n    break;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"If else","code":"if (salary < 5000000) {\n  taxRate = 0.05;\n} else if (salary <= 15000000) {\n  taxRate = 0.1;\n}"},{"title":"Switch case","code":"switch (action) {\n  case \"create\":\n    createItem();\n    break;\n  case \"edit\":\n    editItem();\n    break;\n}"}]
      }
    ]
  },
  {
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function functionName(parameters) {\n  // Logic xử lý\n}"},{"title":"Ví dụ","code":"function sum(a, b) {\n  return a + b;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function functionName() {\n  statements;\n}"},{"title":"Ví dụ","code":"function showMessage() {\n  console.log(\"Chào mừng bạn đến với JavaScript!\");\n}"}]
      },
      {
        "id": "js-call-function",
        "title": "Gọi function",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"functionName(arguments);"},{"title":"Ví dụ","code":"function showMessage() {\n  console.log(\"Xin chào!\");\n}\n\nshowMessage();"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function functionName(parameterA, parameterB) {\n  ...\n}"},{"title":"Ví dụ","code":"function sum(firstNumber, secondNumber) {\n  return firstNumber + secondNumber;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"functionName(argumentA, argumentB);"},{"title":"Ví dụ","code":"function sum(a, b) {\n  return a + b;\n}\n\nconst result = sum(5, 10);"}]
      },
      {
        "id": "js-return",
        "title": "Return",
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function functionName() {\n  return result;\n}"},{"title":"Ví dụ","code":"function calculateTotal(unitPrice, quantity) {\n  return unitPrice * quantity;\n}\n\nconst total = calculateTotal(150000, 2);"}]
      },
      {
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const globalVariable = value;\n\nfunction example() {\n  const localVariable = value;\n}"},{"title":"Ví dụ","code":"const courseName = \"JavaScript\";\n\nfunction showCourse() {\n  const message = `Khóa học ${courseName}`;\n  console.log(message);\n}\n\n// console.log(message); // ReferenceError"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const functionName = function (parameters) {\n  statements;\n};"},{"title":"Ví dụ","code":"const sum = function (a, b) {\n  return a + b;\n};\n\nconsole.log(sum(5, 10));"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function (parameters) {\n  statements;\n}"},{"title":"Ví dụ","code":"button.addEventListener(\"click\", function () {\n  console.log(\"Button đã được bấm\");\n});"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const functionName = (parameters) => expression;"},{"title":"Ví dụ","code":"const sum = (a, b) => a + b;\n\nconsole.log(sum(5, 10));"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function higherOrderFunction(callback) {\n  callback();\n}"},{"title":"Ví dụ","code":"const courses = [\"HTML\", \"CSS\", \"JavaScript\"];\n\ncourses.forEach(function (course) {\n  console.log(course);\n});"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function outerFunction() {\n  function innerFunction() {\n    ...\n  }\n}"},{"title":"Ví dụ","code":"function calculateOrder(price) {\n  function calculateShipping() {\n    return price >= 500000 ? 0 : 30000;\n  }\n\n  return price + calculateShipping();\n}"}]
      },
      {
        "id": "js-recursion",
        "title": "Đệ quy",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function recursiveFunction(value) {\n  if (stopCondition) return result;\n  return recursiveFunction(nextValue);\n}"},{"title":"Ví dụ","code":"function factorial(number) {\n  if (number <= 1) return 1;\n  return number * factorial(number - 1);\n}\n\nconsole.log(factorial(5)); // 120"}]
      }
    ]
  },
  {
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const variableName = \"text\";"},{"title":"Ví dụ","code":"const courseName = \"JavaScript cơ bản\";\nconsole.log(typeof courseName); // string"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const singleQuote = 'text';\nconst doubleQuote = \"text\";\nconst backtick = `text`;"},{"title":"Ví dụ","code":"const userName = 'Tú';\nconst productName = \"Khóa học JavaScript\";\nconst message = `Xin chào ${userName}`;"}]
      },
      {
        "id": "js-string-concat",
        "title": "Nối chuỗi",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"stringA + stringB;"},{"title":"Ví dụ","code":"const firstName = \"Nguyễn\";\nconst lastName = \"Tú\";\nconst fullName = firstName + \" \" + lastName;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"`Text ${expression}`"},{"title":"Ví dụ","code":"const userName = \"Tú\";\nconst courseName = \"JavaScript\";\nconst message = `Xin chào ${userName}, bạn đang học ${courseName}`;"}]
      },
      {
        "id": "js-string-length",
        "title": "Độ dài chuỗi",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.length;"},{"title":"Ví dụ","code":"const password = \"12345678\";\nconst isValid = password.length >= 8;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string[index];\nstring.charAt(index);"},{"title":"Ví dụ","code":"const language = \"JavaScript\";\nconsole.log(language[0]); // J\nconsole.log(language.charAt(4)); // S"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.indexOf(searchValue, fromIndex);"},{"title":"Ví dụ","code":"const email = \"user@example.com\";\nconst atPosition = email.indexOf(\"@\");\nconst hasAtSign = atPosition !== -1;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.includes(searchValue, position);"},{"title":"Ví dụ","code":"const title = \"Học JavaScript cơ bản\";\nconsole.log(title.includes(\"JavaScript\")); // true"}]
      },
      {
        "id": "js-string-slice",
        "title": "Slice",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.slice(startIndex, endIndex);"},{"title":"Ví dụ","code":"const orderCode = \"ORDER-2026-001\";\nconst prefix = orderCode.slice(0, 5); // ORDER"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.replace(searchValue, newValue);"},{"title":"Ví dụ","code":"const lesson = \"Học JS cơ bản\";\nconst updatedLesson = lesson.replace(\"JS\", \"JavaScript\");"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.toUpperCase();"},{"title":"Ví dụ","code":"const couponInput = \"sale20\";\nconst couponCode = couponInput.toUpperCase(); // SALE20"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.toLowerCase();"},{"title":"Ví dụ","code":"const emailInput = \"USER@EXAMPLE.COM\";\nconst email = emailInput.toLowerCase();"}]
      },
      {
        "id": "js-string-trim",
        "title": "Trim",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.trim();"},{"title":"Ví dụ","code":"const emailInput = \"  user@example.com  \";\nconst cleanEmail = emailInput.trim();"}]
      },
      {
        "id": "js-string-split",
        "title": "Split",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.split(separator, limit);"},{"title":"Ví dụ","code":"const skillText = \"HTML,CSS,JS\";\nconst skills = skillText.split(\",\");\n// [\"HTML\", \"CSS\", \"JS\"]"}]
      },
      {
        "id": "js-number",
        "title": "Number",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const variableName = numericValue;"},{"title":"Ví dụ","code":"const productPrice = 150000;\nconst quantity = 3;\nconst total = productPrice * quantity;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"Number(value);\n+value;"},{"title":"Ví dụ","code":"const quantityInput = \"3\";\nconst quantity = Number(quantityInput);\nconst total = 150000 * quantity;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"parseInt(string, radix);"},{"title":"Ví dụ","code":"const value = parseInt(\"10.5\", 10);\nconsole.log(value); // 10"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"parseFloat(string);"},{"title":"Ví dụ","code":"const value = parseFloat(\"10.5\");\nconsole.log(value); // 10.5"}]
      },
      {
        "id": "js-number-nan",
        "title": "NaN",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"NaN"},{"title":"Ví dụ","code":"const result = Number(\"abc\");\nconsole.log(result); // NaN\nconsole.log(typeof result); // number"}]
      },
      {
        "id": "js-number-is-nan",
        "title": "IsNaN",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"Number.isNaN(value);"},{"title":"Ví dụ","code":"const quantity = Number(\"abc\");\n\nif (Number.isNaN(quantity)) {\n  console.log(\"Số lượng không hợp lệ\");\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"number.toFixed(digits);"},{"title":"Ví dụ","code":"const averageScore = 7.6666;\nconst formattedScore = averageScore.toFixed(2);\nconsole.log(formattedScore); // \"7.67\""}]
      }
    ]
  },
  {
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const date = new Date();"},{"title":"Ví dụ","code":"const updatedAt = new Date();\nconsole.log(updatedAt);"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"new Date();\nnew Date(dateString);\nnew Date(year, monthIndex, day);"},{"title":"Ví dụ","code":"const now = new Date();\nconst releaseDate = new Date(2026, 6, 14);\nconst isoDate = new Date(\"2026-07-14T08:30:00+07:00\");"}]
      },
      {
        "id": "js-date-get-year",
        "title": "Lấy năm",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"date.getFullYear();"},{"title":"Ví dụ","code":"const birthDate = new Date(2000, 4, 20);\nconst birthYear = birthDate.getFullYear(); // 2000"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"date.getMonth(); // từ 0 đến 11"},{"title":"Ví dụ","code":"const date = new Date(2026, 6, 14);\nconst displayMonth = date.getMonth() + 1; // 7"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"date.getDate();"},{"title":"Ví dụ","code":"const updatedAt = new Date(2026, 6, 14);\nconsole.log(updatedAt.getDate()); // 14"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"date.getDay(); // từ 0 đến 6"},{"title":"Ví dụ","code":"const weekdays = [\"Chủ nhật\", \"Thứ hai\", \"Thứ ba\", \"Thứ tư\", \"Thứ năm\", \"Thứ sáu\", \"Thứ bảy\"];\nconst today = new Date();\nconst weekdayName = weekdays[today.getDay()];"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"date.getHours();\ndate.getMinutes();\ndate.getSeconds();\ndate.getMilliseconds();"},{"title":"Ví dụ","code":"const loginAt = new Date();\nconst time = {\n  hours: loginAt.getHours(),\n  minutes: loginAt.getMinutes(),\n  seconds: loginAt.getSeconds(),\n};"}]
      },
      {
        "id": "js-timestamp",
        "title": "Timestamp",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"Date.now();\ndate.getTime();"},{"title":"Ví dụ","code":"const createdAt = new Date(\"2026-07-14T08:00:00+07:00\");\nconst elapsedMilliseconds = Date.now() - createdAt.getTime();"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"date.toLocaleDateString(locale, options);\nnew Intl.DateTimeFormat(locale, options).format(date);"},{"title":"Ví dụ","code":"const date = new Date(2026, 6, 14);\nconst formattedDate = new Intl.DateTimeFormat(\"vi-VN\", {\n  day: \"2-digit\",\n  month: \"2-digit\",\n  year: \"numeric\",\n}).format(date);\n// 14/07/2026"}]
      },
      {
        "id": "js-regex",
        "title": "Regex",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const regex = /pattern/flags;\nconst regex = new RegExp(\"pattern\", \"flags\");"},{"title":"Ví dụ","code":"const emailPattern = /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/;\nconsole.log(emailPattern.test(\"user@example.com\")); // true"}]
      },
      {
        "id": "js-regex-pattern",
        "title": "Pattern",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"/pattern/flags"},{"title":"Ví dụ","code":"const digitPattern = /\\d+/g;\nconst simpleEmailPattern = /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/;"}]
      },
      {
        "id": "js-regex-test",
        "title": "Test",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"regex.test(string);"},{"title":"Ví dụ","code":"const emailPattern = /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/;\nconst isValid = emailPattern.test(\"user@example.com\");"}]
      },
      {
        "id": "js-regex-match",
        "title": "Match",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.match(regex);"},{"title":"Ví dụ","code":"const text = \"Liên hệ 0912345678 hoặc 0987654321\";\nconst phoneNumbers = text.match(/0\\d{9}/g);\n// [\"0912345678\", \"0987654321\"]"}]
      },
      {
        "id": "js-regex-replace",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"string.replace(regex, replacement);"},{"title":"Ví dụ","code":"const text = \"Học   JavaScript    cơ bản\";\nconst normalizedText = text.trim().replace(/\\s+/g, \" \");\n// \"Học JavaScript cơ bản\""}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const emailPattern = /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/;"},{"title":"Ví dụ","code":"function isValidEmail(email) {\n  const emailPattern = /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/;\n  return emailPattern.test(email.trim());\n}\n\nconsole.log(isValidEmail(\"user@example.com\")); // true"}]
      },
      {
        "id": "js-strict-mode",
        "title": "Strict mode",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"\"use strict\";"},{"title":"Ví dụ","code":"\"use strict\";\n\n// userName = \"Tú\"; // ReferenceError\nconst userName = \"Tú\";"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Lợi ích chính","code":"- Ngăn vô tình tạo biến global\n- Báo lỗi cho một số thao tác không hợp lệ\n- Giúp tối ưu và bảo trì code dễ hơn"},{"title":"Ví dụ","code":"\"use strict\";\n\nfunction updateUser() {\n  // email = \"new@example.com\"; // ReferenceError\n  const email = \"new@example.com\";\n  return email;\n}"}]
      }
    ]
  },
  {
