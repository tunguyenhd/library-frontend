...
export const nodeGroups: KnowledgeGroup[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        codeBlocks: [
          { title: "Event Loop — Thứ tự xử lý", code: "// ┌───────────────────────────┐\n// │      Call Stack            │ ← Chạy code đồng bộ\n// │  console.log(), if/else    │\n// └──────────┬────────────────┘\n//            │ (xong 1 vòng)\n//            ▼\n// ┌───────────────────────────┐\n// │    Microtask Queue         │ ← Promise.then, queueMicrotask\n// │    (ƯU TIÊN CAO)          │    Chạy HẾT trước khi qua macro\n// └──────────┬────────────────┘\n//            │ (hết microtask)\n//            ▼\n// ┌───────────────────────────┐\n// │    Macrotask Queue         │ ← setTimeout, setInterval, I/O\n// │    (chạy 1 task / vòng)    │\n// └───────────────────────────┘" },
          { title: "Minh họa thứ tự", code: "console.log('1: Bắt đầu');           // Call Stack\n\nsetTimeout(() => {\n  console.log('2: Timeout (macro)');  // Macrotask Queue\n}, 0);\n\nPromise.resolve().then(() => {\n  console.log('3: Promise (micro)');  // Microtask Queue\n});\n\nconsole.log('4: Kết thúc');           // Call Stack\n\n// Output: 1 → 4 → 3 → 2\n// Giải thích:\n// 1,4: Call Stack chạy trước (đồng bộ)\n// 3: Microtask (Promise) chạy TRƯỚC macrotask\n// 2: Macrotask (setTimeout) chạy SAU cùng" }
        ]
      },
      {
        id: "node-modules",
