    ...
    cards: [
      {
        ...
        codeBlocks: [
          { title: "Ý tưởng component", code: "function KnowledgeCard() {\n  return <article>Thẻ kiến thức</article>;\n}" },
          { title: "Ví dụ", code: "function App() {\n  return (\n    <main>\n      <Header />\n      <Sidebar />\n      <KnowledgeCard />\n    </main>\n  );\n}" },
        ],
      },
      {
        id: "react-vite",
        ...
        codeBlocks: [
          { title: "Khởi tạo project", code: "npm create vite@latest my-react-app -- --template react" },
          { title: "Chạy project", code: "cd my-react-app\nnpm install\nnpm run dev" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Cấu trúc", code: "my-react-app/\n├── index.html\n├── package.json\n├── vite.config.js\n└── src/\n    ├── components/\n    │   ├── Header.jsx\n    │   └── KnowledgeCard.jsx\n    ├── App.jsx\n    ├── main.jsx\n    └── index.css" },
          { title: "Gợi ý", code: "// components: giao diện tái sử dụng\n// App.jsx: component gốc\n// main.jsx: điểm khởi chạy React" },
        ],
      },
      {
        id: "react-main-jsx",
        ...
        codeBlocks: [
          { title: "index.html", code: "<div id=\"root\"></div>\n<script type=\"module\" src=\"/src/main.jsx\"></script>" },
          { title: "main.jsx", code: "import { StrictMode } from \"react\";\nimport { createRoot } from \"react-dom/client\";\nimport App from \"./App.jsx\";\n\ncreateRoot(document.getElementById(\"root\")).render(\n  <StrictMode>\n    <App />\n  </StrictMode>,\n);" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "createRoot(domNode).render(<App />);" },
          { title: "Ví dụ", code: "import { createRoot } from \"react-dom/client\";\nimport App from \"./App.jsx\";\n\nconst rootElement = document.getElementById(\"root\");\ncreateRoot(rootElement).render(<App />);" },
        ],
      },
      {
        id: "react-app-jsx",
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "export default function App() {\n  return <main>...</main>;\n}" },
          { title: "Ví dụ", code: "import Header from \"./components/Header.jsx\";\nimport Sidebar from \"./components/Sidebar.jsx\";\n\nexport default function App() {\n  return (\n    <>\n      <Header />\n      <main className=\"layout\">\n        <Sidebar />\n        <section>Nội dung kiến thức</section>\n      </main>\n    </>\n  );\n}" },
        ],
      },
      {
        id: "react-component",
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "function ComponentName() {\n  return <div>...</div>;\n}" },
          { title: "Ví dụ", code: "function KnowledgeCard() {\n  return (\n    <article className=\"knowledge-card\">\n      <h2>Component</h2>\n      <p>Khối giao diện có thể tái sử dụng.</p>\n    </article>\n  );\n}" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "function ComponentName() {\n  return JSX;\n}" },
          { title: "Ví dụ", code: "export default function Header() {\n  return (\n    <header>\n      <h1>React Knowledge</h1>\n    </header>\n  );\n}" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "import ComponentName from \"./path/ComponentName.jsx\";" },
          { title: "Ví dụ", code: "import Header from \"./components/Header.jsx\";\n\nexport default function App() {\n  return <Header />;\n}" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Default export", code: "export default function Sidebar() {\n  return <aside>Sidebar</aside>;\n}" },
          { title: "Named export", code: "export function Sidebar() {\n  return <aside>Sidebar</aside>;\n}\n\n// import { Sidebar } from \"./Sidebar.jsx\";" },
        ],
      },
      {
        id: "react-jsx",
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "const element = <h1>Xin chào React</h1>;" },
      ...
      },
      {
        ...
        codeBlocks: [
          { title: "Cú pháp", code: "<p>{javascriptExpression}</p>" },
          { title: "Ví dụ", code: "function CourseList() {\n  const userName = \"Tú\";\n  const courses = [\"Component\", \"Props\", \"State\"];\n\n  return (\n    <section>\n      <h2>Xin chào {userName}</h2>\n      <ul>\n        {courses.map((course) => (\n          <li key={course}>{course}</li>\n        ))}\n      </ul>\n    </section>\n  );\n}" },
        ],
      },
      {
        ...
        codeBlocks: [
          { title: "Component con", code: "function Header() {\n  return <header>Header</header>;\n}" },
          { title: "Component cha", code: "function App() {\n  return (\n    <>\n      <Header />\n      <Sidebar />\n      <Content />\n      <Footer />\n    </>\n  );\n}" },
        ],
      },
      {
        id: "react-jsx-rules",
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Element>{javascriptExpression}</Element>"},{"title":"Ví dụ","code":"function TopicHeader() {\n  const topic = \"ReactJS\";\n  return <h1>{topic} Knowledge</h1>;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Element>{variableName}</Element>"},{"title":"Ví dụ","code":"function CourseTitle() {\n  const courseName = \"ReactJS\";\n  return <h2>{courseName}</h2>;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Element>{expression}</Element>"},{"title":"Ví dụ","code":"function OrderTotal() {\n  const unitPrice = 150000;\n  const quantity = 2;\n\n  return <p>Thành tiền: {unitPrice * quantity}đ</p>;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"return condition ? <TrueUI /> : <FalseUI />;"},{"title":"Ví dụ","code":"function Account({ isLoggedIn, userName }) {\n  if (isLoggedIn) {\n    return <p>Xin chào {userName}</p>;\n  }\n\n  return <button type=\"button\">Đăng nhập</button>;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"{condition ? <TrueUI /> : <FalseUI />}"},{"title":"Ví dụ","code":"function LoginStatus({ isLogin }) {\n  return (\n    <p>\n      {isLogin ? \"Xin chào người dùng\" : \"Vui lòng đăng nhập\"}\n    </p>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"{condition && <UI />}"},{"title":"Ví dụ","code":"function NewLessonNotice({ lessons }) {\n  return (\n    <section>\n      {lessons.length > 0 && <p>Bạn có bài học mới</p>}\n    </section>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"if (!condition) return null;"},{"title":"Ví dụ","code":"function Popup({ isOpen }) {\n  if (!isOpen) return null;\n\n  return <section role=\"dialog\">Nội dung popup</section>;\n}"}]
      },
      {
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"{array.map((item) => <Component key={item.id} />)}"},{"title":"Ví dụ","code":"function CourseList({ courses }) {\n  return (\n    <div>\n      {courses.map((course) => (\n        <CourseItem key={course.id} course={course} />\n      ))}\n    </div>\n  );\n}"}]
      },
      {
        "id": "react-key",
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Component con","code":"function KnowledgeCard({ title, explanation, example }) {\n  return (\n    <article>\n      <h2>{title}</h2>\n      <p>{explanation}</p>\n      <code>{example}</code>\n    </article>\n  );\n}"},{"title":"Render từ array","code":"function KnowledgeList({ items }) {\n  return items.map((item) => (\n    <KnowledgeCard\n      key={item.id}\n      title={item.title}\n      explanation={item.explanation}\n      example={item.example}\n    />\n  ));\n}"}]
      },
      {
        "id": "react-fragment",
        "title": "Fragment",
        ...
        "codeBlocks": [{"title":"Cú pháp ngắn","code":"<>\n  <ElementA />\n  <ElementB />\n</>"},{"title":"Ví dụ","code":"function Introduction() {\n  return (\n    <>\n      <h2>ReactJS</h2>\n      <p>Thư viện xây dựng giao diện.</p>\n    </>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"className={condition ? \"base active\" : \"base\"}"},{"title":"Ví dụ","code":"function MenuItem({ title, isActive }) {\n  return (\n    <a\n      href=\"#section\"\n      className={`menu-item${isActive ? \" active\" : \"\"}`}\n    >\n      {title}\n    </a>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"if (isLoading) return <LoadingUI />;\nif (hasError) return <ErrorUI />;\nif (items.length === 0) return <EmptyUI />;"},{"title":"Ví dụ","code":"function LessonList({ lessons, isLoading, error }) {\n  if (isLoading) return <p>Đang tải...</p>;\n  if (error) return <p>Không tải được bài học.</p>;\n  if (lessons.length === 0) return <p>Chưa có bài học nào.</p>;\n\n  return lessons.map((lesson) => (\n    <LessonCard key={lesson.id} lesson={lesson} />\n  ));\n}"}]
      }
    ]
  },
  {
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Element onEventName={eventHandler} />"},{"title":"Ví dụ","code":"function Lesson() {\n  const handleShowMore = () => {\n    console.log(\"Hiển thị thêm nội dung\");\n  };\n\n  return <button onClick={handleShowMore}>Xem thêm</button>;\n}"}]
      },
      {
        "id": "react-on-click",
        "title": "onClick",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<button onClick={handleClick}>Nội dung</button>"},{"title":"Ví dụ","code":"function TopicButton({ onNavigate }) {\n  return (\n    <button type=\"button\" onClick={() => onNavigate(\"html\")}>\n      HTML\n    </button>\n  );\n}"}]
      },
      {
        "id": "react-on-change",
        "title": "onChange",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<input onChange={handleChange} />"},{"title":"Ví dụ","code":"function LessonInput() {\n  const [lessonName, setLessonName] = useState(\"\");\n\n  return (\n    <input\n      value={lessonName}\n      onChange={(event) => setLessonName(event.target.value)}\n    />\n  );\n}"}]
      },
      {
        "id": "react-on-submit",
        "title": "onSubmit",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<form onSubmit={handleSubmit}>...</form>"},{"title":"Ví dụ","code":"function LessonForm() {\n  const handleSubmit = (event) => {\n    event.preventDefault();\n    console.log(\"Thêm bài học\");\n  };\n\n  return (\n    <form onSubmit={handleSubmit}>\n      <input name=\"lessonName\" />\n      <button type=\"submit\">Thêm</button>\n    </form>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Element onMouseEnter={handleMouseEnter} />"},{"title":"Ví dụ","code":"<article onMouseEnter={() => setHovered(true)}>\n  <h2>React Events</h2>\n  {hovered && <button>Xem chi tiết</button>}\n</article>"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Element onMouseLeave={handleMouseLeave} />"},{"title":"Ví dụ","code":"<article\n  onMouseEnter={() => setHovered(true)}\n  onMouseLeave={() => setHovered(false)}\n>\n  {hovered && <button>Xem chi tiết</button>}\n</article>"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<button onClick={handleClick}>Click</button>"},{"title":"Ví dụ","code":"function SaveButton() {\n  function handleClick() {\n    console.log(\"Đã lưu\");\n  }\n\n  return <button onClick={handleClick}>Lưu</button>;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Sai","code":"<button onClick={handleClick()}>Click</button>\n// handleClick chạy ngay khi render."},{"title":"Đúng","code":"<button onClick={handleClick}>Click</button>\n<button onClick={() => handleSelect(courseId)}>Chọn</button>"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"onClick={() => handler(argument)}"},{"title":"Ví dụ","code":"function LessonItem({ lesson, onSelect }) {\n  return (\n    <button onClick={() => onSelect(lesson.id)}>\n      {lesson.title}\n    </button>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function handler(event) {\n  // event.currentTarget\n}"},{"title":"Ví dụ","code":"function SearchInput() {\n  const [keyword, setKeyword] = useState(\"\");\n\n  const handleChange = (event) => {\n    setKeyword(event.currentTarget.value);\n  };\n\n  return <input value={keyword} onChange={handleChange} />;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"event.preventDefault();"},{"title":"Ví dụ","code":"function handleSubmit(event) {\n  event.preventDefault();\n  addLesson();\n}\n\nreturn <form onSubmit={handleSubmit}>...</form>;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"event.stopPropagation();"},{"title":"Ví dụ","code":"function LessonCard({ lesson, onOpen, onDelete }) {\n  return (\n    <article onClick={() => onOpen(lesson.id)}>\n      <h2>{lesson.title}</h2>\n      <button\n        onClick={(event) => {\n          event.stopPropagation();\n          onDelete(lesson.id);\n        }}\n      >\n        Xóa\n      </button>\n    </article>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function handleEventName(event) {\n  statements;\n}"},{"title":"Ví dụ","code":"function handleAddLesson() {\n  console.log(\"Thêm bài học\");\n}\n\nfunction handleDeleteLesson(lessonId) {\n  console.log(\"Xóa\", lessonId);\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<button onClick={() => shortAction()}>Click</button>"},{"title":"Ví dụ","code":"function ToggleButton() {\n  const [isOpen, setIsOpen] = useState(false);\n\n  return (\n    <button onClick={() => setIsOpen((current) => !current)}>\n      {isOpen ? \"Đóng\" : \"Mở\"}\n    </button>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function handleSubmit(event) {\n  event.preventDefault();\n  // Logic xử lý\n}\n\nreturn <form onSubmit={handleSubmit}>...</form>;"},{"title":"Ví dụ","code":"function LessonForm() {\n  const [title, setTitle] = useState(\"\");\n\n  function handleSubmit(event) {\n    event.preventDefault();\n    if (!title.trim()) return;\n    addLesson(title.trim());\n    setTitle(\"\");\n  }\n\n  return (\n    <form onSubmit={handleSubmit}>\n      <input value={title} onChange={(event) => setTitle(event.target.value)} />\n      <button type=\"submit\">Thêm</button>\n    </form>\n  );\n}"}]
      }
    ]
  },
  {
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function ComponentName(props) {\n  return <div>{props.value}</div>;\n}"},{"title":"Ví dụ","code":"function KnowledgeCard({ title, description, example }) {\n  return (\n    <article>\n      <h2>{title}</h2>\n      <p>{description}</p>\n      <code>{example}</code>\n    </article>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<ChildComponent propName={value} />"},{"title":"Ví dụ","code":"function ReactPage() {\n  return (\n    <KnowledgeCard\n      title=\"Props\"\n      description=\"Dữ liệu truyền từ cha xuống con\"\n    />\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Nhận object props","code":"function ChildComponent(props) {\n  return <h2>{props.title}</h2>;\n}"},{"title":"Ví dụ","code":"function KnowledgeCard(props) {\n  return (\n    <article>\n      <h2>{props.title}</h2>\n      <p>{props.description}</p>\n    </article>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function ComponentName({ propA, propB }) {\n  ...\n}"},{"title":"Ví dụ","code":"function KnowledgeCard({ title, description }) {\n  return (\n    <article>\n      <h2>{title}</h2>\n      <p>{description}</p>\n    </article>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Component text=\"Chuỗi cố định\" />\n<Component text={stringVariable} />"},{"title":"Ví dụ","code":"function CourseItem({ courseName }) {\n  return <h2>{courseName}</h2>;\n}\n\n<CourseItem courseName=\"ReactJS\" />;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Component count={10} />"},{"title":"Ví dụ","code":"function CourseProgress({ lessonCount, progress }) {\n  return <p>{lessonCount} bài học — {progress}%</p>;\n}\n\n<CourseProgress lessonCount={24} progress={65} />;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Component isActive={true} />\n<Component isActive />"},{"title":"Ví dụ","code":"function SidebarItem({ title, isActive }) {\n  return (\n    <a className={isActive ? \"item active\" : \"item\"}>\n      {title}\n    </a>\n  );\n}\n\n<SidebarItem title=\"Props\" isActive />;"}]
      },
      {
        "id": "react-array-prop",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Component items={arrayValue} />"},{"title":"Ví dụ","code":"function LessonList({ lessons }) {\n  return (\n    <ul>\n      {lessons.map((lesson) => <li key={lesson}>{lesson}</li>)}\n    </ul>\n  );\n}\n\n<LessonList lessons={[\"JSX\", \"Props\", \"State\"]} />;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Component item={objectValue} />"},{"title":"Ví dụ","code":"const course = {\n  id: 1,\n  title: \"ReactJS\",\n  description: \"React cơ bản\",\n  image: \"/images/react.png\",\n};\n\nfunction CourseCard({ course }) {\n  return <h2>{course.title}</h2>;\n}\n\n<CourseCard course={course} />;"}]
      },
      {
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function ComponentName({ propName = defaultValue }) {\n  ...\n}"},{"title":"Ví dụ","code":"function KnowledgeCard({\n  title = \"Chưa có tiêu đề\",\n  description = \"Chưa có mô tả\",\n}) {\n  return (\n    <article>\n      <h2>{title}</h2>\n      <p>{description}</p>\n    </article>\n  );\n}"}]
      },
      {
        "id": "react-children",
        "title": "Children",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<Component>\n  Nội dung children\n</Component>"},{"title":"Ví dụ","code":"<Card>\n  <h2>Props & Children</h2>\n  <p>Nội dung của card.</p>\n  <button>Xem thêm</button>\n</Card>"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function ComponentName({ children }) {\n  return <div>{children}</div>;\n}"},{"title":"Ví dụ","code":"function Modal({ title, children }) {\n  return (\n    <section role=\"dialog\">\n      <h2>{title}</h2>\n      <div className=\"modal-content\">{children}</div>\n    </section>\n  );\n}\n\n<Modal title=\"Xác nhận\">\n  <p>Bạn có muốn xóa bài học?</p>\n</Modal>;"}]
      },
      {
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Ví dụ props drilling","code":"function App() {\n  const user = { name: \"Tú\" };\n  return <Layout user={user} />;\n}\n\nfunction Layout({ user }) {\n  return <Sidebar user={user} />;\n}\n\nfunction Sidebar({ user }) {\n  return <UserInfo user={user} />;\n}"},{"title":"Hướng xử lý","code":"// 1. Đưa component cần dữ liệu lên gần nguồn hơn\n// 2. Dùng composition/children\n// 3. Dùng Context khi dữ liệu thật sự dùng ở nhiều tầng"}]
      }
    ]
  },
  {
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const [state, setState] = useState(initialValue);"},{"title":"Ví dụ","code":"function Sidebar() {\n  const [isOpen, setIsOpen] = useState(false);\n\n  return (\n    <aside className={isOpen ? \"sidebar open\" : \"sidebar\"}>\n      <button onClick={() => setIsOpen(true)}>Mở sidebar</button>\n    </aside>\n  );\n}"}]
      },
      {
        "id": "react-use-state",
        "title": "useState",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"import { useState } from \"react\";\n\nconst [state, setState] = useState(initialValue);"},{"title":"Ví dụ","code":"import { useState } from \"react\";\n\nfunction SearchBox() {\n  const [keyword, setKeyword] = useState(\"\");\n  return <input value={keyword} onChange={(event) => setKeyword(event.target.value)} />;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"useState(initialValue);\nuseState(() => createInitialValue());"},{"title":"Ví dụ","code":"const [isMenuOpen, setIsMenuOpen] = useState(false);\nconst [lessonName, setLessonName] = useState(\"\");\nconst [lessons, setLessons] = useState([]);\nconst [selectedLesson, setSelectedLesson] = useState(null);"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"setState(newValue);"},{"title":"Ví dụ","code":"function Menu() {\n  const [isOpen, setIsOpen] = useState(false);\n\n  return (\n    <button onClick={() => setIsOpen(true)}>\n      {isOpen ? \"Menu đang mở\" : \"Mở menu\"}\n    </button>\n  );\n}"}]
      },
      {
        "id": "react-re-render",
        "title": "Re-render",
        ...
        "codeBlocks": [{"title":"Luồng hoạt động","code":"Event → setState → React render lại → cập nhật DOM"},{"title":"Ví dụ","code":"function Quantity() {\n  const [quantity, setQuantity] = useState(1);\n\n  return (\n    <button onClick={() => setQuantity((current) => current + 1)}>\n      Số lượng: {quantity}\n    </button>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const [text, setText] = useState(\"\");"},{"title":"Ví dụ","code":"function SearchInput() {\n  const [keyword, setKeyword] = useState(\"\");\n\n  return (\n    <>\n      <input value={keyword} onChange={(event) => setKeyword(event.target.value)} />\n      <p>Từ khóa: {keyword}</p>\n    </>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const [count, setCount] = useState(0);"},{"title":"Ví dụ","code":"function Counter() {\n  const [count, setCount] = useState(0);\n\n  return (\n    <button onClick={() => setCount((current) => current + 1)}>\n      Đã bấm {count} lần\n    </button>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const [isOpen, setIsOpen] = useState(false);"},{"title":"Ví dụ","code":"function ModalExample() {\n  const [isOpen, setIsOpen] = useState(false);\n\n  return (\n    <>\n      <button onClick={() => setIsOpen(true)}>Mở modal</button>\n      {isOpen && <Modal onClose={() => setIsOpen(false)} />}\n    </>\n  );\n}"}]
      },
      {
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const [form, setForm] = useState(initialObject);\nsetForm((current) => ({ ...current, key: newValue }));"},{"title":"Ví dụ","code":"function RegisterForm() {\n  const [form, setForm] = useState({\n    name: \"\",\n    email: \"\",\n    password: \"\",\n    phone: \"\",\n  });\n\n  function updateEmail(email) {\n    setForm((current) => ({ ...current, email }));\n  }\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"setState((previousState) => nextState);"},{"title":"Ví dụ","code":"function Counter() {\n  const [count, setCount] = useState(0);\n\n  function increaseThreeTimes() {\n    setCount((current) => current + 1);\n    setCount((current) => current + 1);\n    setCount((current) => current + 1);\n  }\n\n  return <button onClick={increaseThreeTimes}>{count}</button>;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Sai","code":"lessons.push(newLesson);\nsetLessons(lessons);"},{"title":"Đúng","code":"setLessons((currentLessons) => [\n  ...currentLessons,\n  newLesson,\n]);\n\nsetUser((currentUser) => ({\n  ...currentUser,\n  email: newEmail,\n}));"}]
      },
      {
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function Component() {\n  const [localState, setLocalState] = useState(initialValue);\n  ...\n}"},{"title":"Ví dụ","code":"function Dropdown() {\n  const [isOpen, setIsOpen] = useState(false);\n\n  return (\n    <div>\n      <button onClick={() => setIsOpen((current) => !current)}>Menu</button>\n      {isOpen && <DropdownMenu />}\n    </div>\n  );\n}"}]
      },
      {
        "id": "react-ui-state",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const [isLoading, setIsLoading] = useState(false);\nconst [error, setError] = useState(null);"},{"title":"Ví dụ","code":"function CourseSection() {\n  const [isLoading, setIsLoading] = useState(true);\n  const [error, setError] = useState(null);\n\n  if (isLoading) return <p>Đang tải dữ liệu...</p>;\n  if (error) return <p>Không tải được dữ liệu.</p>;\n  return <CourseList />;\n}"}]
      }
    ]
  },
  {
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function FormComponent() {\n  const [form, setForm] = useState(initialForm);\n  return <form onSubmit={handleSubmit}>...</form>;\n}"},{"title":"Ví dụ","code":"function KnowledgeForm() {\n  const [title, setTitle] = useState(\"\");\n\n  function handleSubmit(event) {\n    event.preventDefault();\n    console.log({ title });\n  }\n\n  return (\n    <form onSubmit={handleSubmit}>\n      <input value={title} onChange={(event) => setTitle(event.target.value)} />\n      <button type=\"submit\">Lưu</button>\n    </form>\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<input value={state} onChange={(event) => setState(event.target.value)} />"},{"title":"Ví dụ","code":"function TitleInput() {\n  const [title, setTitle] = useState(\"\");\n\n  return (\n    <input\n      value={title}\n      onChange={(event) => setTitle(event.target.value)}\n      placeholder=\"Tên bài học\"\n    />\n  );\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<input type=\"text\" value={value} onChange={handleChange} />"},{"title":"Ví dụ","code":"<label>\n  Tiêu đề bài học\n  <input\n    type=\"text\"\n    value={title}\n    onChange={(event) => setTitle(event.target.value)}\n  />\n</label>"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<textarea value={value} onChange={handleChange} />"},{"title":"Ví dụ","code":"<label>\n  Giải thích\n  <textarea\n    value={description}\n    onChange={(event) => setDescription(event.target.value)}\n    rows={6}\n  />\n</label>"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<select value={value} onChange={handleChange}>\n  <option value=\"...\">...</option>\n</select>"},{"title":"Ví dụ","code":"<select\n  value={category}\n  onChange={(event) => setCategory(event.target.value)}\n>\n  <option value=\"html\">HTML</option>\n  <option value=\"css\">CSS</option>\n  <option value=\"js\">JavaScript</option>\n  <option value=\"react\">ReactJS</option>\n</select>"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<input\n  type=\"checkbox\"\n  checked={isChecked}\n  onChange={(event) => setIsChecked(event.target.checked)}\n/>"},{"title":"Ví dụ","code":"<label>\n  <input\n    type=\"checkbox\"\n    checked={isCompleted}\n    onChange={(event) => setIsCompleted(event.target.checked)}\n  />\n  Đã hoàn thành\n</label>"}]
      },
      {
        "id": "react-form-radio",
        "title": "Radio",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<input\n  type=\"radio\"\n  name=\"group\"\n  value=\"option\"\n  checked={state === \"option\"}\n  onChange={handleChange}\n/>"},{"title":"Ví dụ","code":"{[\"easy\", \"medium\", \"hard\"].map((value) => (\n  <label key={value}>\n    <input\n      type=\"radio\"\n      name=\"level\"\n      value={value}\n      checked={level === value}\n      onChange={(event) => setLevel(event.target.value)}\n    />\n    {value}\n  </label>\n))}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"<form onSubmit={handleSubmit}>\n  ...\n  <button type=\"submit\">Gửi</button>\n</form>"},{"title":"Ví dụ","code":"function handleSubmit(event) {\n  event.preventDefault();\n  addLesson({ title, description });\n}\n\nreturn (\n  <form onSubmit={handleSubmit}>\n    <input value={title} onChange={(event) => setTitle(event.target.value)} />\n    <button type=\"submit\">Thêm bài học</button>\n  </form>\n);"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"function handleSubmit(event) {\n  event.preventDefault();\n}"},{"title":"Ví dụ","code":"function handleSubmit(event) {\n  event.preventDefault();\n  saveLesson(form);\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Nhiều state","code":"const [title, setTitle] = useState(\"\");\nconst [description, setDescription] = useState(\"\");\nconst [category, setCategory] = useState(\"react\");\nconst [level, setLevel] = useState(\"easy\");"},{"title":"Object state","code":"const [form, setForm] = useState({\n  title: \"\",\n  description: \"\",\n  category: \"react\",\n  level: \"easy\",\n});"}]
      },
      {
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"{errors.field && <p role=\"alert\">{errors.field}</p>}"},{"title":"Ví dụ","code":"<label htmlFor=\"email\">Email</label>\n<input\n  id=\"email\"\n  value={form.email}\n  onChange={handleChange}\n  aria-invalid={Boolean(errors.email)}\n  aria-describedby={errors.email ? \"email-error\" : undefined}\n/>\n{errors.email && (\n  <p id=\"email-error\" role=\"alert\">{errors.email}</p>\n)}"}]
      },
      {
        "id": "react-reset-form",
        "title": "Reset form",
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"setForm(initialForm);\nsetErrors({});"},{"title":"Ví dụ","code":"const initialForm = {\n  title: \"\",\n  description: \"\",\n  category: \"react\",\n};\n\nfunction resetForm() {\n  setForm(initialForm);\n  setErrors({});\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cấu trúc","code":"<input name=\"name\" value={form.name} onChange={handleChange} />\n<input name=\"email\" value={form.email} onChange={handleChange} />\n<input name=\"password\" value={form.password} onChange={handleChange} />"},{"title":"Handler dùng chung","code":"function handleChange(event) {\n  const { name, value } = event.target;\n  setForm((current) => ({\n    ...current,\n    [name]: value,\n  }));\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"State","code":"const [form, setForm] = useState({\n  title: \"\",\n  description: \"\",\n  category: \"react\",\n  level: \"easy\",\n  isCompleted: false,\n});"},{"title":"Handler dùng chung","code":"function handleChange(event) {\n  const { name, type, value, checked } = event.target;\n\n  setForm((current) => ({\n    ...current,\n    [name]: type === \"checkbox\" ? checked : value,\n  }));\n}"}]
      }
    ]
  },
  {
    ...
    "cards": [
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"import { useEffect } from \"react\";\n\nuseEffect(() => {\n  // Thiết lập effect\n  return () => {\n    // Cleanup nếu cần\n  };\n}, [dependencies]);"},{"title":"Ví dụ","code":"function ReactPage() {\n  useEffect(() => {\n    document.title = \"ReactJS Knowledge\";\n  }, []);\n\n  return <main>ReactJS</main>;\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Ví dụ side effect","code":"useEffect(() => {\n  localStorage.setItem(\"theme\", theme);\n  document.title = `Theme: ${theme}`;\n}, [theme]);"},{"title":"Không cần effect","code":"// Tính trực tiếp trong render\nconst fullName = `${firstName} ${lastName}`;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"useEffect(effectFunction, [dependencyA, dependencyB]);"},{"title":"Ví dụ","code":"useEffect(() => {\n  searchLessons(keyword);\n}, [keyword]);"}]
      },
      {
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const response = await fetch(url, options);\nif (!response.ok) throw new Error(`HTTP ${response.status}`);\nconst data = await response.json();"},{"title":"Ví dụ","code":"async function fetchCourses(signal) {\n  const response = await fetch(\"/api/courses\", { signal });\n  if (!response.ok) throw new Error(`HTTP ${response.status}`);\n  return response.json();\n}"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const [isLoading, setIsLoading] = useState(false);"},{"title":"Ví dụ","code":"async function loadCourses() {\n  setIsLoading(true);\n  try {\n    const data = await fetchCourses();\n    setCourses(data);\n  } finally {\n    setIsLoading(false);\n  }\n}\n\nif (isLoading) return <p>Đang tải dữ liệu...</p>;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"const [error, setError] = useState(null);"},{"title":"Ví dụ","code":"try {\n  setError(null);\n  const data = await fetchCourses();\n  setCourses(data);\n} catch (error) {\n  setError(error instanceof Error ? error.message : \"Lỗi không xác định\");\n}\n\nif (error) return <p role=\"alert\">{error}</p>;"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Cú pháp","code":"{data.map((item) => (\n  <Component key={item.id} item={item} />\n))}"},{"title":"Ví dụ","code":"function CourseList({ courses }) {\n  if (courses.length === 0) return <p>Chưa có khóa học.</p>;\n\n  return (\n    <section>\n      {courses.map((course) => (\n        <CourseCard key={course.id} course={course} />\n      ))}\n    </section>\n  );\n}"}]
      },
      {
      ...
      },
      {
        ...
        "codeBlocks": [{"title":"Có thể gây lặp","code":"useEffect(() => {\n  fetchCourses().then(setCourses);\n}, [courses]);\n// setCourses thay đổi courses, effect lại chạy."},{"title":"Sửa","code":"useEffect(() => {\n  fetchCourses().then(setCourses);\n}, []);\n\n// Hoặc phụ thuộc đúng tham số request:\nuseEffect(() => {\n  fetchCourses(category).then(setCourses);\n}, [category]);"}]
      },
      {
        ...
        "codeBlocks": [{"title":"Sai","code":"useEffect(async () => {\n  const response = await fetch(url);\n}, []);"},{"title":"Đúng","code":"useEffect(() => {\n  const controller = new AbortController();\n\n  async function loadCourses() {\n    try {\n      const response = await fetch(\"/api/courses\", {\n        signal: controller.signal,\n      });\n      if (!response.ok) throw new Error(`HTTP ${response.status}`);\n      const data = await response.json();\n      setCourses(data);\n    } catch (error) {\n      if (error.name !== \"AbortError\") setError(error.message);\n    }\n  }\n\n  loadCourses();\n  return () => controller.abort();\n}, []);"}]
      }
    ]
  },
  {
